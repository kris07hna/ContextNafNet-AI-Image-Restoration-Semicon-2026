...
**SEMICON Hackathon 2026 Submission | Team Solution**
...
```bash
# Option 1: Direct pip install from requirements.txt (Includes CUDA wheel index)
pip install -r requirements.txt

# Option 2: Explicit CUDA 12.1 PyTorch installation command
...
```
team_name/
├── run.py                 # Official KLA submission entrypoint (python run.py <input-dir> <output-dir>)
├── requirements.txt       # Dependencies with CUDA PyTorch index
